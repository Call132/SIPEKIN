...
@section('title', 'Feedback Performance Appraisal')

@section('main')
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Feedback Performance Appraisal</h1>
        </div>
    ...
    <form>
        @csrf
        <input type="hidden" name="performance_appraisal_id" value="{{ $data->id }}">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mb-2" id="name" name="name" readonly
                                value="{{ $employee->name }}">
                            ...
                            <input type="text" class="form-control mb-2" id="staff_identity_card_no"
                                name="staff_identity_card_no" readonly value="{{ $employee->staffIdentityCardNo }}">

                            <label for="department">Department:</label>
                            <input type="text" class="form-control mb-2" id="department" name="department" readonly
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control mb-2" id="date_joined" name="date_joined" readonly
                                value="{{ $employee->dateJoined }}">

                            <label for="position">Position:</label>
                            <input type="text" class="form-control mb-2" id="position" name="position" readonly
                            ...
                            <input type="date" class="form-control mb-2" id="date_in_present_position"
                                name="date_in_present_position" readonly
                ...
                <table class="table" id="part_ii_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="10"><input type="text" class="form-control" id="part_ii_total"
                                    name="part_ii_total" readonly></td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="card col-12 mt-3">
            ...
            <div class="card-body">
                ...
                <textarea class="form-control mb-2" id="strengths" name="strengths"
                    rows="3">{{ $generalRating->strengths }}</textarea>

                <label for="weaknesses">2. Weaknesses of the staff:</label>
                <textarea class="form-control mb-2" id="weaknesses" name="weakness"
                    rows="3"> {{ $generalRating->weakness }}</textarea>

                <label for="suggestions">3. Suggestions (e.g., Training required to improve weaknesses, development
                    to
                    optimize strengths, etc):</label>
                <textarea class="form-control mb-2" id="suggestions" name="suggestions"
                    rows="3"> {{ $generalRating->suggestions }}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="form-check">
                        ...
                        <input type="text" class="form-control" id="promotable_1_2_years_position"
                            ...
                            value="{{ $generalRating->promotable_1_2_years_position }}">
                        ...
                        <input type="text" class="form-control" id="promotable_1_2_years_successor"
                            ...
                            value="{{ $generalRating->promotable_1_2_years_successor }}">
                    </div>
                    ...
                    <div class="form-check">
                        ...
                        'limited_to_current_position' ? 'checked' : '' }} >
        ...
        <div class="card col-12 mt-3">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="feedback" name="feedback" rows="3">{{ $feedbacks->feedback }}</textarea>
                </div>
            </div>
        </div>
        ...
        @endif
        <div class="d-flex">
            <a href="{{ route('hasil.index') }}" class="btn btn-primary w-100">Kembali</a>
        </div>
    </form>
</div>
@endsection
